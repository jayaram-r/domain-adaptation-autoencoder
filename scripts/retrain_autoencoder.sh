#!/bin/bash
base_dir='/Users/jr/Documents/research/code/domain_adaptation/results_sim_final'
...
for snr in 4 6 8 10 12 16 18 20; do
    ...
    for type_channel in 'fading'; do
        for type_autoenc in 'symbol_estimation_map'; do
